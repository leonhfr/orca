...
func TestQuiescence(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			depth:  4,
			result: quiescenceSearchTestResult{nodes: 4965, score: 4},
		...
		},
		{
			...
			fen:    "5r1k/4Qpq1/4p3/1p1p2P1/2p2P2/1p2P3/3P4/BK6 b - - 0 1",
			depth:  5,
			result: quiescenceSearchTestResult{nodes: 21862, score: 3},
		...
		},
		{
			...
			fen:    "5r1k/4Qpq1/4p3/1p1p2P1/2p2P2/1p2P3/3P4/BK6 b - - 0 1",
			depth:  6,
			result: quiescenceSearchTestResult{nodes: 57828, score: 0},
